export { ArticleJsonLdProps, default as ArticleJsonLd } from './jsonld/article';
export { BrandJsonLdProps, default as BrandJsonLd } from './jsonld/brand';
export {
...
export { CourseJsonLdProps, default as CourseJsonLd } from './jsonld/course';
export { DatasetJsonLdProps, default as DatasetJsonLd } from './jsonld/dataset';
